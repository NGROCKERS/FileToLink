...
class Config:
    API_ID = int(os.environ.get("3563028"))
    API_HASH = os.environ.get("d119ea76a256e81446faacdb20a204d8")
    Token = os.environ.get("5061986561:AAFb6oo3zkfvlKqUW1Tu5eOgyu4siKY1SI8")
    Session = os.environ.get("Session_String")
    if Session is None or Session == "":
        Session = ":memory:"
    App_Name = os.environ.get("mallustream")
    Port = int(os.environ.get("8080"))
    Archive_Channel_ID = int(os.environ.get("-1001407831884"))
    Start_Message = os.environ.get("Start_Message")
    Bot_Channel = os.environ.get("@MALLUROCKERSCLUB")
